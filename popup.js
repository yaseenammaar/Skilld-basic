...
chrome.storage.sync.get(ACTIVITY_TRACK, (resp) => {
    ...
    $(".follow-use").text(`${activites[ACTIVITY_NAMES.FOLLOWS]}/50`)
    $(".tweet-use").text(`${activites[ACTIVITY_NAMES.TWEETS]}/50`)
    $(".messages-use").text(`${activites[ACTIVITY_NAMES.MESSAGES]}/50`)
})
